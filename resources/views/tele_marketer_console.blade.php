                    ...
                    <form id="leads_form" class="m-form m-form--label-align-right m-form--group-seperator-dashed m-form--state" method="post" action="{{ route('leads.update', $lead) }}">
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-sm-12 col-md-3 m-form__group-sub {{ $errors->has('email') ? 'has-danger' : ''}}">
                            ...
                            <div class="form-group m-form__group row">
                                <div class="col-sm-12 col-md-3 m-form__group-sub {{ $errors->has('address') ? 'has-danger' : ''}}">
                                ...
                                <div class="col-sm-12 col-md-3 m-form__group-sub {{ $errors->has('state') ? 'has-danger' : ''}}">
                                ...
                                <div class="col-sm-12 col-md-3 m-form__group-sub {{ $errors->has('comment') ? 'has-danger' : ''}}">
