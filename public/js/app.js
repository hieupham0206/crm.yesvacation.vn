...
window.cloudTeamCore = __webpack_require__(46);

//VUE
window.Vue = __webpack_require__(47);

Vue.component('flash', __webpack_require__(50));
...
if ($('#txt_quicksearch').length > 0) {
	...
	var quicksearch = new mQuicksearch('txt_quicksearch', {
...
$('#activity_log_container.m-scrollable').on('ps-y-reach-end', function () {
	...
	var url = route('activity_logs.get_more_logs');
	...
	axios.get(url, {
		...
		var isEmpty = result.data.isEmpty;
		var items = '';
		var _iteratorNormalCompletion = true;
		var _didIteratorError = false;
		var _iteratorError = undefined;
		...
		$(_this).find('.m-list-timeline__items').append(items);

		if (isEmpty) {
			$(_this).off('ps-y-reach-end');
		}
	}).finally(function () {
...
var cloudTeamCore = function ($, lang) {
	...
	var handleDatepicker = function handleDatepicker() {
		...
		if (typeof $.fn.datetimepicker === 'function') {
			...
			$('.text-dateptimeicker, .input-group.datetime').datetimepicker();
		}
	};
	...
	var handleDatatables = function handleDatatables() {
		...
		if (typeof $.fn.dataTable === 'function') {
			var language = $('html').attr('lang');
			var optionLang = {
				'sLengthMenu': 'Display <select class="m_selectpicker m-bootstrap-select--air" data-width="85px">' + '<option value="10">10</option>' + '<option value="20">20</option>' + '<option value="30">30</option>' + '<option value="40">40</option>' + '<option value="50">50</option>' + '<option value="-1">All</option>' + '</select> records',
				'sSearch': 'Search:',
				'oPaginate': {
			...
			if (language === 'vi') {
				optionLang = {
					...
					'sLengthMenu': 'Xem <select class="m_selectpicker m-bootstrap-select--air" data-width="85px">' + '<option value="10">10</option>' + '<option value="20">20</option>' + '<option value="30">30</option>' + '<option value="40">40</option>' + '<option value="50">50</option>' + '<option value="-1">All</option>' + '</select> dòng',
...
var update = __webpack_require__(53)("75d14d1b", content, false, {});
